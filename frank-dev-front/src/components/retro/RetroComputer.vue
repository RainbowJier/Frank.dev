  ...
  <div class="product-col">
    <div class="scene">
      <div class="computer-unit">
            ...
            <div class="crt">
              <div class="crt-glow">
                <div class="crt-ui">
                  <div class="sidebar">
                    <div class="icon-list">
                      <div><span class="icon-circle blue"></span> System</div>
                      <div><span class="icon-circle orange"></span> Disk A</div>
                      <div><span class="icon-circle"></span> Trash</div>
                      <div><span class="icon-circle"></span> Write</div>
                      <div><span class="icon-circle"></span> Think</div>
                    </div>
                  </div>
                  <div class="main-area">
                    <div class="figos-label">FigOS 1.0</div>
                    <div class="window">
                      ...
                      <div class="typing-container">
                        <span ref="typewriter"></span><span class="cursor"></span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <!-- Keyboard -->
        <div v-if="showKeyboard" class="keyboard-assembly">
          <div class="kb-base">
            <div class="keys-grid">
              <!-- Row 1 -->
...
const props = defineProps({
  crtText: {
    type: String,
    default: 'Good morning. Your memo is drafted, your files are sorted, and your calendar is set. Ready when you are.'
  },
  showKeyboard: {
    type: Boolean,
    default: true
...
.logo-badge {
  ...
  background: linear-gradient(180deg,
    #63B548 0%, #63B548 16.6%,
    #F6C829 16.6%, #F6C829 33.3%,
    #E57D25 33.3%, #E57D25 50%,
    #D83335 50%, #D83335 66.6%,
    #9C4595 66.6%, #9C4595 83.3%,
    #468CCF 83.3%, #468CCF 100%);
